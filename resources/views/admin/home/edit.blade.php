...
@section('admin')
    ...
    <div class="col-lg-12">
        <div class="card card-default">
            ...
            <div class="card-body">
                <form action="{{url('update/abouthome/'.$homeAbout->id)}}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" name="short_desc">{{$homeAbout->short_desc}}</textarea>
                    </div>
                    <div class="form-group">
